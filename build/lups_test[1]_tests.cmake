...
add_test( EvalTest.BooleanLiteral [==[/home/eemil/dev/c++/lups/build/lups_test]==] [==[--gtest_filter=EvalTest.BooleanLiteral]==] --gtest_also_run_disabled_tests)
set_tests_properties( EvalTest.BooleanLiteral PROPERTIES WORKING_DIRECTORY [==[/home/eemil/dev/c++/lups/build]==] SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test( EvalTest.PrefixExpression [==[/home/eemil/dev/c++/lups/build/lups_test]==] [==[--gtest_filter=EvalTest.PrefixExpression]==] --gtest_also_run_disabled_tests)
set_tests_properties( EvalTest.PrefixExpression PROPERTIES WORKING_DIRECTORY [==[/home/eemil/dev/c++/lups/build]==] SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
set( lups_test_TESTS LexerTest.TestNextToken LexerTest.IfStatements LexerTest.Variables LexerTest.FunctionDeclaration LexerTest.EqualNonEqual ParserTest.LetStatements ParserTest.ReturnStatements ParserTest.IdentifierExpression ParserTest.IntegerLiteralExpression ParserTest.PrefixExpressionTest ParserTest.InfixExpressionTest ParserTest.BooleanInfixExpression ParserTest.OperatorPrecedenceParsing ParserTest.IfExpressionTest ParserTest.FunctionLiteralParsing ParserTest.FunctionParameterTest ParserTest.CallExpressionParsing ParsetTest.BooleanPrefixExpressionTest EvalTest.IntegerExpressions EvalTest.BooleanLiteral EvalTest.PrefixExpression)
