...
add_test( ParserTest.PrefixExpressionTest [==[/home/eemil/dev/c++/lups/nodeps/build/lups_test]==] [==[--gtest_filter=ParserTest.PrefixExpressionTest]==] --gtest_also_run_disabled_tests)
set_tests_properties( ParserTest.PrefixExpressionTest PROPERTIES WORKING_DIRECTORY [==[/home/eemil/dev/c++/lups/nodeps/build]==] SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test( ParserTest.InfixExpressionTest [==[/home/eemil/dev/c++/lups/nodeps/build/lups_test]==] [==[--gtest_filter=ParserTest.InfixExpressionTest]==] --gtest_also_run_disabled_tests)
set_tests_properties( ParserTest.InfixExpressionTest PROPERTIES WORKING_DIRECTORY [==[/home/eemil/dev/c++/lups/nodeps/build]==] SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test( ParserTest.BooleanInfixExpression [==[/home/eemil/dev/c++/lups/nodeps/build/lups_test]==] [==[--gtest_filter=ParserTest.BooleanInfixExpression]==] --gtest_also_run_disabled_tests)
set_tests_properties( ParserTest.BooleanInfixExpression PROPERTIES WORKING_DIRECTORY [==[/home/eemil/dev/c++/lups/nodeps/build]==] SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test( ParserTest.OperatorPrecedenceParsing [==[/home/eemil/dev/c++/lups/nodeps/build/lups_test]==] [==[--gtest_filter=ParserTest.OperatorPrecedenceParsing]==] --gtest_also_run_disabled_tests)
set_tests_properties( ParserTest.OperatorPrecedenceParsing PROPERTIES WORKING_DIRECTORY [==[/home/eemil/dev/c++/lups/nodeps/build]==] SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test( ParserTest.IfExpressionTest [==[/home/eemil/dev/c++/lups/nodeps/build/lups_test]==] [==[--gtest_filter=ParserTest.IfExpressionTest]==] --gtest_also_run_disabled_tests)
set_tests_properties( ParserTest.IfExpressionTest PROPERTIES WORKING_DIRECTORY [==[/home/eemil/dev/c++/lups/nodeps/build]==] SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
add_test( ParsetTest.BooleanPrefixExpressionTest [==[/home/eemil/dev/c++/lups/nodeps/build/lups_test]==] [==[--gtest_filter=ParsetTest.BooleanPrefixExpressionTest]==] --gtest_also_run_disabled_tests)
set_tests_properties( ParsetTest.BooleanPrefixExpressionTest PROPERTIES WORKING_DIRECTORY [==[/home/eemil/dev/c++/lups/nodeps/build]==] SKIP_REGULAR_EXPRESSION [==[\[  SKIPPED \]]==])
set( lups_test_TESTS LexerTest.TestNextToken LexerTest.IfStatements LexerTest.Variables LexerTest.FunctionDeclaration LexerTest.EqualNonEqual ParserTest.LetStatements ParserTest.ReturnStatements ParserTest.IdentifierExpression ParserTest.IntegerLiteralExpression ParserTest.PrefixExpressionTest ParserTest.InfixExpressionTest ParserTest.BooleanInfixExpression ParserTest.OperatorPrecedenceParsing ParserTest.IfExpressionTest ParsetTest.BooleanPrefixExpressionTest)
